...
<section class="esqueci">
    <main>
        <h1>Vamos enviar um Email</h1>

        <div class="Eemail">
            <a href="https://accounts.google.com/v3/signin/identifier?dsh=S-1006566744%3A1684952817799097&hl=pt-BR&ifkv=Af_xneGa4oI8gjieQV8c-2MaR18sJS90KcJFNbre9G_k0x3-Rg1jHnXOpiR4yZCZmMTa36Kg9U1TSw&flowName=GlifWebSignIn&flowEntry=ServiceLogin">
        ...
        <label for="Celular">
         ...
         <div class="inputfield">
          ...
          <input type="tell" id="celular" name="celular" pattern="^[\(\d{2}\)\d{4,5}-\d{4}&" required autocomplete="mobile">
         </div>
        </label>
